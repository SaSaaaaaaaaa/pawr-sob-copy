                    ...
                    <form>
                        <div class="row g-4">
                            ...
                            <div
                                ...
                                <a href="{{route('cart')}}" class="primary-btn3">Add to cart</a>
                            </div>
        ...
        <div class="col-lg-12">
            ...
            <div class="tab-content tab-content2" id="v-pills-tabContent2">
                <div class="tab-pane fade active show" id="v-pills-home" role="tabpanel"
                    ...
                    <div class="description">
                        <p class="para-2 mb-3">Our pet care service provides various forms of care for pets,
                            including feeding, exercise, grooming, and overall well-being. This type of service
                            can be provided in the pet owner's home or at a facility, such as a pet hotel or
                            boarding kennel. We also offer additional services such as training, transportation,
                            and medical care. We are specialize in caring for a specific type of animal, such as
                            cats or dogs, while others may be able to care for a variety of different types of
                            pets. The level of our care and type of services offered will vary depending on the
                            specific pet care service.</p>
                        <p class="para-2">This Pet care services can be a great option for busy pet owners who
                            are unable to provide the necessary care for their pets due to work or other
                            commitments. They can also be a helpful resource for pet owners who are traveling
                            and need someone to look after their pets while they are away.</p>
                    </div>
                    <div class="row g-lg-4 gy-5">
                        <div class="col-lg-6">
                            <p class="para-2 mb-2">There is often ask some questions about the pet care service
                                and we always try to give all the answer of their questions. Before taking
                                services it is important to know about the service process and its advantages or
                                disadvantages. Here is some questions and answers we set as standard.</p>
                ...
                <div class="tab-pane fade" id="v-pills-profile" role="tabpanel"
                    ...
                    <div class="description">
                        <p class="para-2 mb-3">Choosing a pet care service, it is important to do your research
                            and select a reputable provider that has experience and a good track record. You
                            should also discuss your pet's needs and any special instructions with the provider
                            to ensure that your pet will receive the best possible care.</p>
                        <ul>
                            <li><strong>Boarding:</strong> This is when you leave your pet at a kennel or other
                                facility while you are away. Boarding facilities typically offer basic care such
                                as feeding, watering, and exercise, as well as additional services like grooming
                                and training.</li>
                            <li><strong>Daycare:</strong> Daycare is a service that provides care for your pet
                                while you are at work or otherwise busy. Daycare facilities typically offer
                                playtime, socialization, and basic care such as feeding and watering.</li>
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="services-card1">
                        ...
                        <div class="content">
                            <h3><a href="{{route('daycare')}}">Daycare </a></h3>
                            <p>Pellentesque maximus augue orciquista ut aliquet risus In hac habitasse.</p>
                        </div>
                        <a class="more-btn" href="{{route('daycare')}}">More Details<img
                                src="/assets/images/icon/btn-arrow1.svg" alt></a>
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="services-card1 two">
                        ...
                        <div class="content">
                            <h3><a href="{{route('daycare')}}">Grooming </a></h3>
                            <p>Pellentesque maximus augue orciquista ut aliquet risus In hac habitasse.</p>
                        </div>
                        <a class="more-btn" href="{{route('daycare')}}">More Details<img
                                src="/assets/images/icon/btn-arrow1.svg" alt></a>
                ...
                <div class="swiper-slide">
                    <div class="services-card1 three">
                        ...
                        <div class="content">
                            <h3><a href="{{route('daycare')}}">Boarding</a></h3>
                            <p>Pellentesque maximus augue orciquista ut aliquet risus In hac habitasse.</p>
                        </div>
                        <a class="more-btn" href="{{route('daycare')}}">More Details<img
                                src="/assets/images/icon/btn-arrow1.svg" alt></a>
                ...
                <div class="swiper-slide">
                    <div class="services-card1 four">
                        ...
                        <div class="content">
                            <h3><a href="{{route('daycare')}}">veterinary</a></h3>
                            <p>Pellentesque maximus augue orciquista ut aliquet risus In hac habitasse.</p>
                        </div>
                        <a class="more-btn" href="{{route('daycare')}}">More Details<img
                                src="/assets/images/icon/btn-arrow1.svg" alt></a>
