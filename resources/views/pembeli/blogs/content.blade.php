                    ...
                    <div class="col-lg-6 col-md-6 col-sm-10">
                        <div class="h1-blog-card">
                            ...
                            <div class="blog-content">
                                ...
                                <h4><a href="blog-details.html">lobortis pharetra In necat boi risuse osae that one
                                        far This fox.</a></h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-10">
                        <div class="h1-blog-card">
                            ...
                            <div class="blog-content">
                                ...
                                <h4><a href="blog-details.html">Donec venenatis ex id nibh iaculisoni Clonal
                                        interdum Curabitur.</a></h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-10">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-10">
                        <div class="h1-blog-card">
                            ...
                            <div class="blog-content">
                                ...
                                <h4><a href="blog-details.html">gravida ut malesuada in tristique sed eros Nunc sed
                                        efficitur.</a></h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-10">
                        <div class="h1-blog-card">
                            ...
                            <div class="blog-content">
                                ...
                                <h4><a href="blog-details.html">luctus justo quis feugiat lacus orcha ornare augue
                                        Integer.</a></h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-10">
                        <div class="h1-blog-card">
                            ...
                            <div class="blog-content">
                                ...
                                <h4><a href="blog-details.html">malesuada nibh Nulla lacinia miegetol bibendum
                                        euismod.</a></h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-10">
                        <div class="h1-blog-card">
                            ...
                            <div class="blog-content">
                                ...
                                <h4><a href="blog-details.html">vitae tortor Maecenas in dui eget orci dapibus
                                        imperdiet.</a></h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-10">
                        <div class="h1-blog-card">
                            ...
                            <div class="blog-content">
                                ...
                                <h4><a href="blog-details.html">semper Praesent sit amet nisi quison massa euismod
                                        facilisis.</a></h4>
                            </div>
                        </div>
                    </div>
