@extends('pembeli.homepage.index')
@section('slider')
<div class="hero2">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                <div class="banner-content">
                                    ...
                                    <div class="btn-group">
                                        <a class="primary-btn2" href="{{route('contact-us')}}">Make a Reservation</a>
                                        <a class="primary-btn3" href="about.html">About More </a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 d-flex justify-content-center">
                                <div class="hero-img">
                                    <img class="img-fluid" src="/assets/images/bg/hero2-img.png" alt>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="services-top">
        <div class="services-section-card">
            ...
            <div class="services-title">
                ...
                <a class="primary-btn2" href="{{route('contact-us')}}">Book Your Day</a>
            </div>
        </div>
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="services-card daycare-card">
                        ...
                        <div class="services-content">
                            ...
                            <div class="more-btn">
                                <a href="shop-details.html">More Details<img
                ...
                <div class="swiper-slide">
                    <div class="services-card grooming-card">
                        ...
                        <div class="services-content">
                            ...
                            <p>Pellentesque maximus augue orciquista uten aliquet risus In hac habitasse.</p>
                            <div class="more-btn">
                                <a href="{{route('daycare')}}">More Details<img
                                        src="/assets/images/icon/h2-btn-arrow.svg" alt></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="swiper-slide">
                    <div class="services-card vaterinary-card">
                        ...
                        <div class="services-content">
                            <h3><a href="{{route('daycare')}}">Vaterinary</a></h3>
                            <p>Pellentesque maximus augue orciquista uten aliquet risus In hac habitasse.</p>
                            <div class="more-btn">
                                <a href="{{route('daycare')}}">More Details<img
                                        src="/assets/images/icon/h2-btn-arrow.svg" alt></a>
                    ...
                    <div class="services-content">
                        ...
                        <div class="author-area">
                            <div class="author-quat">
                                <p><sup><img src="/assets/images/icon/author-quat-icon.svg" alt></sup> Pllentesque
                                    maximus augue orci, quis congue purus iaculisona ideno joku Maecenas eu lorem
                                    quisesdoi massal molestie jugnute vulputate in sitagajoi amet diam Cras eu odio
                                    sit amet.</p>
                            </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title2 text-center">
                    <h2>Why Choose Us</h2>
                    <p>Enjoy Your Holiday We Can Keep Them Happy <a href="#">Your Pet Our Priority</a> Happy Pets,
                        Happy Humans We Are The Best Of This Country We Are Always Ready For your pet.</p>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="contact-img">
                            <img class="img-fluid" src="/assets/images/bg/h2-contact-img.png" alt="contact-img">
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="section-title">
                            ...
                            <div class="team-card">
                                <div class="team-card-inner">
                                    <div class="card-style-1">
                                        <div class="team-img">
                                            <img class="img-fluid" src="/assets/images/bg/team/h2-team-1.png" alt>
                                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="team-card">
                                <div class="team-card-inner">
                                    <div class="card-style-1">
                                        <div class="team-img">
                                            <img class="img-fluid" src="/assets/images/bg/team/h2-team-2.png" alt>
                                        </div>
                                        <div class="team-content">
                        ...
                        <div class="swiper-slide">
                            <div class="team-card">
                                <div class="team-card-inner">
                                    <div class="card-style-1">
                                        <div class="team-img">
                                            <img class="img-fluid" src="/assets/images/bg/team/h2-team-3.png" alt>
                                        </div>
                                        <div class="team-content">
                                            <h3>Jackson Mateo</h3>
                        ...
                        <div class="swiper-slide">
                            <div class="team-card">
                                <div class="team-card-inner">
                                    <div class="card-style-1">
                                        <div class="team-img">
                                            <img class="img-fluid" src="/assets/images/bg/team/h2-team-4.png" alt>
                                        </div>
                                        <div class="team-content">
                                            <h3>Madison Ellie</h3>
                        ...
                        <div class="swiper-slide">
                            <div class="team-card">
                                <div class="team-card-inner">
                                    <div class="card-style-1">
                                        <div class="team-img">
                                            <img class="img-fluid" src="/assets/images/bg/team/h2-team-5.png" alt>
                                        </div>
                                        <div class="team-content">
            ...
            <div class="col-lg-4 col-md-6 col-sm-10">
                <div class="blog-card-2">
                    ...
                    <div class="blog-content">
                        ...
                        <h4><a href="blog-details.html">Donec venenatis exid nibah goramt iaculisoni or Clonal
                                interdum.</a></h4>
                        <div class="more-btn">
            ...
            <div class="col-lg-4 col-md-6 col-sm-10">
                <div class="blog-card-2">
                    ...
                    <div class="blog-content">
                        ...
                        <h4><a href="blog-details.html">Cras a mattis sapien Duis efficituroi mollis enim
                                dictum.</a></h4>
                        <div class="more-btn">
                            <a href="blog-details.html"><span>Re</span>ad More</a>
                        </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-10">
                <div class="blog-card-2">
                    ...
                    <div class="blog-content">
                        ...
                        <h4><a href="blog-details.html">Etiam fringilla consectetur nullaqul molestie neque
                                volutpat.</a></h4>
                        <div class="more-btn">
                            <a href="blog-details.html"><span>Re</span>ad More</a>
                        </div>
