<header class="header-area style-2">
    <div class="container-fluid d-flex justify-content-between align-items-center">
        <div class="header-logo">
            <a href="{{route('homepage')}}"><img alt="image" class="img-fluid" src="/assets/images/header2-logo.svg"></a>
        </div>
        <div class="main-menu">
            <div class="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
                <div class="mobile-logo-wrap">
                    <a href="{{route('homepage')}}"><img alt="image" src="/assets/images/header2-logo.svg"></a>
                </div>
            ...
            <ul class="menu-list">
                ...
                <li class="menu-item-has-children">
                    ...
                    <ul class="sub-menu">
                        <li><a href="{{route('daycare')}}">Daycare </a></li>
                        <li><a href="{{route('daycare')}}">Grooming</a></li>
                        <li><a href="{{route('daycare')}}">Boarding</a></li>
                        <li><a href="{{route('daycare')}}">Veterinary</a></li>
                    </ul>
                </li>
                <li class="menu-item">
        ...
        <div class="nav-right d-flex jsutify-content-end align-items-center">
            <ul>
                ...
                <a class="dropdown-item d-flex align-items-center" href="{{ route('logout') }}"
                  ...
                  <i class="bi bi-box-arrow-right" style="color: #ff6b55"></i>
                </a>
                </form>
            </li>
                <li><strong>{{Auth::user()->nama_lengkap}}</strong>
                </li>
            </ul>
            <div class="hotline-info">
