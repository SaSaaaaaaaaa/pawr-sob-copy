    ...
    <div class="col-lg-5">
        <div class="shop-details-content">
            ...
            <div class="compare-wishlist-area">
                <ul>
                    <li><a href="#"><span><img src="/assets/images/icon/compare.svg" alt></span> Compare</a>
                    </li>
                    <li><a href="#"><span><img src="/assets/images/icon/Icon-favorites2.svg" alt></span> Add
                            to wishlist</a></li>
                </ul>
            </div>
        ...
        <div class="tab-content tab-content2" id="v-pills-tabContent2">
            <div class="tab-pane fade active show" id="v-pills-home" role="tabpanel"
                ...
                <div class="description">
                    <p class="para-2 mb-3">This is a type of food that is specifically formulated and
                        intended for consumption by pets. It is usually sold in the form of dry kibble or
                        wet cans, and is designed to meet the nutritional needs of a variety of different
                        types of pets, including dogs, cats, and small animals like guinea pigs and rabbits.
                    </p>
                    <p class="para-2 mb-3">This food may help from a variety of different ingredients,
                        including meat, grains, vegetables, and fortified vitamins and minerals. Some pet
                        food is formulated for specific life stages, such as puppy or senior, and may
                        contain higher levels of certain nutrients to support the needs of pets at those
                        stages of life.</p>
                ...
                <div class="addithonal-information">
                    <table class="table total-table2">
                        <tbody>
                            ...
                            <tr>
                                <td>Carbohydrates</td>
                                <td>10%, provide energy and help pets maintain healthy weight and keep good
                                    the digestive system.</td>
                            </tr>
                            <tr>
                                <td>Minerals</td>
