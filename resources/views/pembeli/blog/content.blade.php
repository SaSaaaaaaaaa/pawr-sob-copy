                    ...
                    <div class="post-content">
                        ...
                        <blockquote>
                            <p><sup><img src="/assets/images/icon/quage-icon-top.svg" alt="image"></sup> Integer quis
                                ...
                                ut laciniaun est urna <sub><img src="/assets/images/icon/quage-icon-btm.svg"
                                        alt="image"></sub></p>
                            <cite>
                                Ezekiel Miles
                            </cite>
                                ...
                                <ul class="comment-reply">
                                    <li>
                                        <div
                                            ...
                                            <div class="comment-content">
                                                <div
                                                    class="c-header d-flex align-items-center justify-content-between">
                                                    <div class="author-area">
                                                        <div class="author-img">
