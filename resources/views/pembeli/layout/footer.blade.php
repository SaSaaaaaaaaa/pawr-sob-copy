                ...
                <div class="footer-items contact ">
                    ...
                    <div class="email mb-30">
                        ...
                        <div class="email-info">
                            <h6 class="mb-10"><a
                                    href="https://demo.egenslab.com/cdn-cgi/l/email-protection#8ee7e0e8e1ceebf6efe3fee2eba0ede1e3"><span
                                        class="__cf_email__"
                                        data-cfemail="d6bfb8b0b996b3aeb7bba6bab3f8b5b9bb">[email&#160;protected]</span></a>
                            </h6>
                            <h6><a
                                    href="https://demo.egenslab.com/cdn-cgi/l/email-protection#345d5a525b74474144445b46401a575b59"><span
                                        class="__cf_email__"
                                        data-cfemail="40292e262f00333530302f32346e232f2d">[email&#160;protected]</span></a>
                            </h6>
                        </div>
                    </div>
                    <div class="email">
            ...
            <div
                ...
                <div class="footer-items">
                    ...
                    <div class="book-btn2 d-flex justify-content-center text-center">
                        <a class="primary-btn2" href="{{route('contact-us')}}">Book Now</a>
                    </div>
                </div>
            </div>
