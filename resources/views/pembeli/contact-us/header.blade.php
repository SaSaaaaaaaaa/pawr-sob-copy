<header class="header-area style-1">
    <div class="container-fluid d-flex justify-content-between align-items-center">
        <div class="header-logo">
            <a href="{{route('homepage')}}"><img alt="image" class="img-fluid" src="/assets/images/header1-logo.svg"></a>
        </div>
        <div class="main-menu">
            <div class="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
                <div class="mobile-logo-wrap">
                    <a href="{{route('homepage')}}"><img alt="image" src="/assets/images/header1-logo.svg"></a>
                </div>
            ...
            <ul class="menu-list">
                ...
                <li class="menu-item active"><a href="{{route('contact-us')}}">Contact</a></li>
            </ul>
