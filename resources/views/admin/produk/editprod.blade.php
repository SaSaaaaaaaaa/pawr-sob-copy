            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('updateprod', ['id' => $produk->id]) }}" method="POST" enctype="multipart/form-data" class="row g-3">
                        ...
                        <div class="col-6">
                            <label for="spesialis_id" class="form-label fw-bold">Kategori</label>
                        ...
                        <div class="col-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control @error('harga') is-invalid @enderror" name="harga" id="harga" pattern="[0-9]+" placeholder="Masukkan harga" required value="{{ $produk->harga }}">
                            </div>
                            @error('harga')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var deskripsiValue = deskripsiInput.value; // Ambil nilai deskripsi dari input tersembunyi

    editor.clipboard.dangerouslyPasteHTML(deskripsiValue); // Isi konten editor
